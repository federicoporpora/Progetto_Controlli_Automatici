...
Dunque, definiamo la funzione estesa $G_e(s) = R_s(s)G(s) = \mu_s G(s)$ e, in Figura \ref{fig:bode_diagram_Ge}, mostriamo il suo diagramma di Bode per verificare se e quali zone proibite vengono attraversate.
...
In aggiunta all'analisi dell'uscita, per completezza si analizza lo sforzo di controllo $\delta u$ richiesto per ottenere le prestazioni teoriche lineari.
