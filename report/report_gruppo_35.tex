...
% Pacchetti per disegnare i grafici (TikZ)
\usepackage{tikz}
\usetikzlibrary{shapes,arrows,positioning,calc}

% Definizioni stili per i blocchi TikZ
\tikzset{
...
\begin{figure}[h]
    \centering
    % Assicurati che questo file esista nella cartella figs/
...
\begin{figure}[h]
    \centering
    % Disegno TikZ per SCHEMA CONTROLLO (Immagine 1)
    \begin{tikzpicture}[auto, node distance=2cm,>=latex']
        ...
        % Etichette segni somma (manuali per precisione)
...
\begin{figure}[h]
    \centering
    % Disegno TikZ per SCHEMA FINALE (Immagine 2)
    \begin{tikzpicture}[auto, node distance=2.5cm,>=latex']
        ...
        % Disturbo in alto (in questo schema semplificato potrebbe essere inteso come generico o assente, ma lo metto come nel diagramma standard se richiesto)
...
\begin{figure}[h]
    \centering
    % PLACEHOLDER REINSERITO
    \fbox{\parbox{0.7\textwidth}{\vspace{2cm} \centering Placeholder: Schema Simulink Linearizzato \vspace{2cm}}}
...
\begin{figure}[h]
    \centering
    % PLACEHOLDER REINSERITO
    \fbox{\parbox{0.7\textwidth}{\vspace{2cm} \centering Placeholder: Risposta linearizzata \vspace{2cm}}}
    \caption{Risposta temporale del sistema linearizzato.}
...
\begin{figure}[h]
    \centering
    % PLACEHOLDER REINSERITO
    \fbox{\parbox{0.7\textwidth}{\vspace{2cm} \centering Placeholder: Reiezione disturbo linearizzata \vspace{2cm}}}
    \caption{Reiezione del disturbo nel sistema linearizzato.}
