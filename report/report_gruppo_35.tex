...
Come mostrato nella griglia di figure sottostante (Figura~\ref{fig:grid_initial_conditions}), il sistema dimostra una notevole robustezza. Per tutte le condizioni iniziali testate, anche quelle estreme (serbatoi quasi vuoti o molto pieni), l'uscita del sistema converge asintoticamente al valore di equilibrio $a_{2,eq}$ senza mostrare comportamenti divergenti.
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        ...
        \caption{Test 1: $a_1$ quasi vuoto.}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figs/cond_ini_2.jpg}
        \caption{Test 2: $a_1$ pieno.}
    \end{subfigure}
    ...
    \begin{subfigure}{0.48\textwidth}
        ...
        \caption{Test 5: Entrambi bassi.}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figs/cond_ini_6.jpg}
        \caption{Test 6: Entrambi alti.}
    \end{subfigure}
    ...
    \begin{subfigure}{0.48\textwidth}
        ...
        \caption{Test 7: $a_1$ vuoto, $a_2$ pieno.}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figs/cond_ini_8.jpg}
        \caption{Test 8: $a_1$ pieno, $a_2$ vuoto.}
    \end{subfigure}
    
    \caption{Risposta del sistema non lineare per diverse condizioni iniziali $a_1(0)$ e $a_2(0)$. In tutti i casi il sistema converge all'equilibrio (linea rossa).}
